...
const LINKS = [
  { label: "Memory Timeline", path: PATHS.MEMORIES },
  { label: "Gentle Companion", path: PATHS.COMPANION },
  { label: "Calm Sounds", path: PATHS.CALM_SOUNDS },
  { label: "Self-Compassion Toolkit", path: PATHS.SELF_COMPASSION },
