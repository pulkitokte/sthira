...
// Small, purely presentational section-heading used to group Home
// content (Part 3). Not a new page, not a new component library — just
// a lightweight label consistent with the rest of the type system.
function HomeSectionLabel({ title }) {
  return (
    <p className="px-1 font-display text-xs font-semibold uppercase tracking-[0.14em] text-stone opacity-60">
      {title}
    </p>
  );
}
  ...
  return (
    <PageContainer className="flex flex-col gap-8">
      ...
      <section className="rounded-4xl bg-surface p-8 shadow-soft">
        ...
        <button
          onClick={() => navigate(PATHS.MORNING_FLOW)}
          className="mt-6 flex w-full items-center justify-center gap-2 rounded-full bg-moss py-4 font-display font-semibold tracking-wide text-canvas shadow-soft transition-colors duration-200 hover:bg-moss-dark min-h-[44px]"
        >
          Start Today's Morning Flow
      ...
      {/* ════════════════════════════════════════════════════════════
          TODAY'S ESSENTIALS — Morning Flow, Hydration, Wellness, and
          anything that reflects the user's actual daily check-in state.
          ════════════════════════════════════════════════════════════ */}
      <div className="flex flex-col gap-5">
        <HomeSectionLabel title="Today's Essentials" />
        ...
        {homeHint.isVisible && (
          <HelperHint
            icon={Sparkles}
            message="New here? Start with Morning Flow — even five minutes counts."
      ...
      {/* ════════════════════════════════════════════════════════════
          RECOVERY — Study Break Recovery, Eye Recovery
          ════════════════════════════════════════════════════════════ */}
      <div className="flex flex-col gap-5">
        <HomeSectionLabel title="Recovery" />
      ...
      {/* ════════════════════════════════════════════════════════════
          MIND & FOCUS — Focus Sessions, Mindful Breathing
          ════════════════════════════════════════════════════════════ */}
      <div className="flex flex-col gap-5">
        <HomeSectionLabel title="Mind & Focus" />
        ...
        <section>
          ...
          <button
            ...
            className="w-full rounded-3xl bg-surface p-5 shadow-soft text-left transition-all duration-200 hover:shadow-md min-h-[44px]"
          >
      ...
      {/* ════════════════════════════════════════════════════════════
          REFLECTION — Mood Journal, Evening Reflection, Emotional Weather
          ════════════════════════════════════════════════════════════ */}
      <div className="flex flex-col gap-5">
        <HomeSectionLabel title="Reflection" />
        ...
        <section>
          ...
          <button
            ...
            className="w-full rounded-3xl text-left transition-all duration-200 hover:shadow-md overflow-hidden min-h-[44px]"
            style={
              todayWeatherDef
                ? {
      ...
      {/* ════════════════════════════════════════════════════════════
          GROWTH — Daily Wisdom, Letters, Gratitude Garden, Memory
          Timeline, Self-Compassion
          ════════════════════════════════════════════════════════════ */}
      <div className="flex flex-col gap-5">
        <HomeSectionLabel title="Growth" />
        ...
        <section>
          ...
          <button
            ...
            className="w-full rounded-3xl p-5 text-left transition-all duration-200 hover:shadow-md min-h-[44px]"
            style={{
              background:
      ...
      {/* ════════════════════════════════════════════════════════════
          CALM SPACES — Digital Sanctuary, Calm Sounds, Gentle Companion
          ════════════════════════════════════════════════════════════ */}
      <div className="flex flex-col gap-5">
        <HomeSectionLabel title="Calm Spaces" />
