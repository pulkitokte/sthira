...
// Completion screen. Custom-built rather than reusing the shared
// CompletionScreen component, since this screen needs two action buttons
// plus stats and a quote, beyond what CompletionScreen's single-button
// API is known to support.
...
export default function MorningFlowCompletion({
  ...
  return (
    <div
      className="min-h-screen flex flex-col items-center justify-center text-center px-6 py-16 gap-8"
      style={{
        background:
